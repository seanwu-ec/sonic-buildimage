...
HWMON_I2C_PATH ="/sys/devices/platform/as7535_32xb_psu/psu{}"
...
class Psu(PsuBase):
    ...
    def __init__(self, psu_index=0):
        ...
        self.hwmon_path = HWMON_I2C_PATH.format(self.index+1)
    ...
    def get_voltage(self):
        ...
        Returns:
            ...
            e.g. 12.1
        """
        vout_path = "{}{}".format(self.hwmon_path, '_vout')
    ...
    def get_current(self):
        ...
        """
        iout_path = "{}{}".format(self.hwmon_path, '_iout')
    ...
    def get_power(self):
        ...
        """
        pout_path = "{}{}".format(self.hwmon_path, '_pout')
    ...
    def get_temperature(self):
        ...
        """
        temp_path = "{}{}".format(self.hwmon_path, '_temp1_input')
    ...
    def get_presence(self):
        ...
        """
        presence_path="{}{}".format(self.hwmon_path, '_present')
    ...
    def get_status(self):
        ...
        """
        power_path="{}{}".format(self.hwmon_path, '_power_good')
